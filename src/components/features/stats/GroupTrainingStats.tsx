...
import { TeachingPlanDetailPanel } from './TeachingPlanDetailPanel';
...
const STATS_TABS: ReadonlyArray<{
  ...
  },
  {
    id: 'teaching',
    label: 'Teaching',
    description: 'Stage and certificate progress',
    icon: '🎓',
    activeClass: 'from-indigo-600 to-purple-700',
  },
  {
    id: 'achievements',
    label: 'Trophies',
  ...
  return (
    ...
    >
      ...
      >
        ...
        {tab === 'teaching' && (
          <div className="space-y-3">
            <TeachingPlanDetailPanel sessions={sessionResults} settings={trainingSettings} />
          </div>
        )}
